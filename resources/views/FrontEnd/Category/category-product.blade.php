...
@section('mainContent')
    ...
    <div class="banner1">
        <div class="container">
            <h3><a href="index.html"><span>Products</span></h3>
        </div>
    </div>
    <!--banner-->
    <!--content-->
                    ...
                    <div class="col-md-3 product-agileinfo-grid">
                        <div class="categories">
                            ...
                            <ul>
                                ...
                                <li><a href="{{route('sub-category-product',['id'=>$subcategory->id])}}">{{$subcategory->sub_category_name}}</a>
                                    ...
                                    <ul>
                                        <li><input type="checkbox"  id="item-2-0" /><label for="item-2-0">Summer Discount Sales</label>
                                            <ul>
                                                ...
                                                <li><a href="{{route('sub-category-product',['id'=>$subcategory->id])}}">{{$subcategory->sub_category_name}}</a></li>
                                                @endif
                                                @endforeach
                                                <li><a href="products.html">Shoes</a></li>
                                                <li><a href="products.html">Pants</a></li>
