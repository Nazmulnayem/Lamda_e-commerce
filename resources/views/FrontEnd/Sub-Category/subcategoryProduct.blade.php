                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        <div class="grid-arrival">
                                                            <figure>
                                                                <a href="{{route('product-details',['id'=>$subcategoryProduct->id])}}" class="new-gri">
                                                                    <div class="grid-img">
                                                                        <img  src="{{asset($subcategoryProduct->product_image)}}" class="img-responsive" alt="">
                                                                    </div>
                                                                    <div class="grid-img">
                                                                        <img  src="{{asset($subcategoryProduct->product_image)}}" class="img-responsive"  alt="">
                                                                    </div>
                                                        ...
                                                        <div class="women">
                                                            <h6><a href="{{route('product-details',['id'=>$subcategoryProduct->id])}}">{{$subcategoryProduct->product_name}}</a></h6>
                                                            <span class="size">XL / XXL / S </span>
                                                            <p ><del>$100.00</del><em class="item_price">{{$subcategoryProduct->product_price}}</em></p>
                                        ...
                                        @foreach($subcategoryProducts as $subcategoryProduct)
                                            <div class="product-tab1">
                                                ...
                                                <div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
                                                    ...
                                                    <div class="women">
                                                        <h6><a href="single.html">{{$subcategoryProduct->product_name}}</a></h6>
                                                        <span class="size">XL / XXL / S </span>
                                                        <p>{{$subcategoryProduct->long_description}}</p>
                                                        <p ><del>$100.00</del><em class="item_price">{{$subcategoryProduct->product_price}}</em></p>
                                                        <a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                                    </div>
                                                </div>
