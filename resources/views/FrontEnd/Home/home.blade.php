            ...
            <div class="core-slider_viewport">
                <div class="core-slider_list">
                    ...
                    <div class="core-slider_item">
                        <img src="{{asset($slideImage->slide_image)}}" class="img-responsive" alt="">
                    </div>
                    @endforeach
                </div>
            </div>
    ...
    <div class="new-arrivals-w3agile">
        <div class="container">
            ...
            <div class="arrivals-grids">
                @foreach($new_arraivals as $new_arraival)
                <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                    <div class="grid-arr">
                        <div  class="grid-arrival">
                            <figure>
                                <a href="{{route('product-details',['id'=>$new_arraival->id])}}" class="new-gri" >
                                    <div class="grid-img">
                                        <img  src="{{asset($new_arraival->product_image)}}" class="img-responsive" alt="">
                                    </div>
                                    <div class="grid-img">
                                        <img  src="{{asset($new_arraival->product_image)}}" class="img-responsive"  alt="">
                                    </div>
                            ...
                            <div class="caption">
                                ...
                                <div class="col-md-3 cap-left simpleCart_shelfItem">
                                    <div class="grid-arr">
                                        <div  class="grid-arrival">
                                            <figure>
                                                <a href="{{asset('product-details',['id'=>$new_product->id])}}">
                                                    <div class="grid-img">
                                                        <img  src="{{asset($new_product->product_image)}}" class="img-responsive" alt="">
                                                    </div>
                                                    <div class="grid-img">
                                                        <img  src="{{asset($new_product->product_image)}}" class="img-responsive"  alt="">
                                                    </div>
                                        ...
                                        <div class="women">
                                            <h6><a href="{{asset('product-details',['id'=>$new_product->id])}}">{{$new_product->product_name}}</a></h6>
